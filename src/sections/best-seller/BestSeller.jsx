...
const pizzaSocksArr = [
    {
        id: 1,
        title: 'גלקטיק',
        description: 'פיצה מהחלל החיצון. כוכבים, גלקסיות, וכל מה שחסר זה חייזר עם קרטון משפחתית.',
    ...
    },
    {
        id: 2,
        title: 'צבי הנינג׳ה',
        description: 'גרביים שצועקים "קאוואבאנגה!" – ירוק, קרב, ופרוסה נוזלת באמצע המשימה.',
    ...
    },
    {
        id: 3,
        title: 'פיקניק',
        description: 'כמו  משבצות אדום-לבן סטייל שולחן של פיצריה שכונתית. תרגיש חופשי לשפוך קטשופ כמו בעפולה.',
    ...
    },
    {
        ...
        description: 'הגרסה הכי אמיתית – בצק זהוב, גבינה מותכת, בלי חרטות.',
    ...
    },
    {
        ...
        title: 'אינסוף פיצה',
        shape: "M165 286.668C40.201 390.958-60.957 289.799 43.333 165-60.957 40.201 40.2-60.957 165 43.333 289.775-60.957 390.958 40.2 286.668 165 390.958 289.704 289.775 390.958 165 286.668Z",
        description: 'פיצה בכל צורה אפשרית – כי החיים קצרים מדי לגרסה אחת.',
        image: images['../../assets/image/pizza/5.png']?.default
    },
    {
        id: 6,
        title: 'קלוז-אפ',
        ...
        description: 'זום-אין על הפיצה – רוטב אדום, גבינה בורחת, ותיאבון בלתי נגמר.',
        image: images['../../assets/image/pizza/6.png']?.default
    },
    {
        id: 7,
        title: 'עגבניות זה המלך',
        ...
        description: 'הבסיס לכל דבר טוב – עגבניות לוקחות את כל הקרדיט.',
        image: images['../../assets/image/pizza/7.png']?.default
    },
    {
        id: 8,
        title: 'טון גבינה',
        shape: "M163.49 327V301.558C80.2103 301.558 0 246.774 0 163.5H25.4234C25.4234 80.2259 80.2103 0 163.49 0V25.4426C246.769 25.4426 327 80.2259 327 163.5H301.577C301.577 246.774 246.769 327 163.49 327Z",
        description: 'הכול נמס כאן – ים של גבינה, בלי סוף, בלי גבולות.',
        image: images['../../assets/image/pizza/8.png']?.default
    },
]
